...
public final class SQLServerDatabaseTypeSubstitutions {
    ...
    @Substitute
    public Object createDatabase(Configuration configuration,
            JdbcConnectionFactory jdbcConnectionFactory,
            StatementInterceptor statementInterceptor) {
        return new SQLServerDatabaseSubstitution(configuration, jdbcConnectionFactory,
    ...
    public static final class SQLServerDatabaseSubstitution {
        ...
        @Alias
        public SQLServerDatabaseSubstitution(Configuration configuration,
                JdbcConnectionFactory jdbcConnectionFactory,
                StatementInterceptor statementInterceptor) {
        }
    }
