...
public class EmbeddedPostgreSQLBootstrapConfiguration {
    ...
    public ConcretePostgreSQLContainer postgresql(
        ...
        ConcretePostgreSQLContainer postgresql =
                new ConcretePostgreSQLContainer(
                        DockerImageName.parse(properties.dockerImage)
        ...
        postgresql = (ConcretePostgreSQLContainer) configureCommonsAndStart(
                postgresql, properties, log);
    ...
    static class ConcretePostgreSQLContainer extends
            PostgreSQLContainer<ConcretePostgreSQLContainer> {
